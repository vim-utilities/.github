...
[heading__opening_issues]:
  #opening-issues
  "Issues are a great way to show that you care about what Vim Utilities maintains!"


Issues are a great way to show that you care about what Vim Utilities maintains, please search existing issues prior to opening new issues, and utilize the following templates when applicable.
...
[heading__pull_requests]:
  #pull-requests
  "Be a hero to Vim Utilities with quality Pull Requests"


Be a hero to Vim Utilities by making quality Pull Requests with the following templates, or utilize the [General Pull Request][branch__current__template__pull_requests__general] template.


### Bug Fixes
[heading__bug_fixes]:
  #bug-fixes
  "Squish'em good! And tell Vim Utilities all about it"


Squish'em good! And tell Vim Utilities all about it though use of the [Bug Fix][branch__current__template__pull_requests__bug_fix] template.
